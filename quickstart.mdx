...
description: "Deploy a first application on Uniac: one service built from a Dockerfile, exposed on a public HTTP endpoint, using uniac plan, project create, link, deploy and status."
---
...
The `api` deployment declaration instantiates `api_definition` as the service
`api`.
