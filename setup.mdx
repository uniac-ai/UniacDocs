...
description: "Uniac machine setup installs the Uniac skill for the coding agent, makes the uniac command available, and connects it to the user's Uniac account. Project creation and application deployment are separate tasks."
---
