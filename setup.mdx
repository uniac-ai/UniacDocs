...
description: "Uniac machine setup installs the Uniac skills for the coding agent, makes the uniac command available, and connects it to the user's Uniac account. Project creation and application deployment are separate tasks."
---

{/* Generated from uniac-ai/agent-skills: agents/agents.md */}
...
| [uniac-quickstart](/quickstart) | A complete first-deployment example. |
