...
description: "uniac.yaml is the entrypoint for an application composition. It describes one or more named resources in YAML: reusable service definitions and the deployment declarations that instantiate them. YAML is the currently supported composition format."
---

{/* Generated from uniac-ai/agent-skills: skills/uniac/references/composition/yaml.md */}
...
The complete field contracts are in [Service](/resources/service/overview)
and [Volume](/resources/volume).
...
| `services.<instance>.public_ports` | No | [Public endpoint declarations](/resources/service/networking#public-endpoints). |
...
[Environment and references](/resources/service/environment) explains
