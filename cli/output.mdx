...
{/* Generated from uniac-ai/agent-skills: skills/uniac/references/cli/output.md */}
...
is supplied. [Resources](/resources/overview) defines the generated
...
[Service observation](/resources/service/overview#observed-state), public
addresses in [Networking](/resources/service/networking), and durable
...
[environment references](/resources/service/environment).
