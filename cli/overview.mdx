---
title: "Uniac CLI"
description: "npm install -g @uniac/cli installs the uniac command with Node 18+. npx -y @uniac/cli … runs the same command without a global installation."
---
...
Deployment addresses an existing [remote project](/project).
...
`plan` performs [description validation](/resources/overview) offline,
