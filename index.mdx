...
{/* Generated from uniac-ai/agent-skills: skills/uniac/references/composition/overview.md */}
...
[Composition in YAML](/composition/yaml) introduces the description file and combines
these parts in an example. Detailed configuration and lifecycle information
is available for [Service](/resources/service/overview) and
