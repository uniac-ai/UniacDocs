---
title: "Project"
description: "A project belongs to an account. Its name is unique within that account and matches ^[a-z][a-z0-9-]{0,62}$; the platform also assigns a project slug. Its services and volumes have identities within the project. Services share a private network."
---

{/* Generated from uniac-ai/agent-skills: skills/uniac/references/project.md */}
...
slug. Its [services](/resources/service/overview)
and [volumes](/resources/volume) have identities within the project.
Services share a [private network](/resources/service/networking).
