...
description: "Services are addressable as <instance>.internal within their project. Internal communication does not require port declarations. Without public exposure, a service is directly reachable only within its project."
---

{/* Generated from uniac-ai/agent-skills: skills/uniac/references/resources/service/networking.md */}
...
In [YAML composition](/composition/yaml),
