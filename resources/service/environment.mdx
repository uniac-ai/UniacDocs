---
title: "Environment and references"
description: "Environment variables provide runtime configuration to a service's containers. Their values can refer to the service's own configuration or to another service in the same project. The platform resolves declared values at deployment time and injects them at container start. Other environment defaults are the image's own."
---

{/* Generated from uniac-ai/agent-skills: skills/uniac/references/resources/service/environment.md */}
...
In [YAML composition](/composition/yaml), the service definition's
