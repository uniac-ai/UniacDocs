...
description: "A service definition's env is an optional mapping of environment variable names to plaintext string values. Names match ^[A-Za-z_][A-Za-z0-9_]*$; host is reserved for the builtin reference."
---
