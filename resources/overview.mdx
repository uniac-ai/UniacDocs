---
title: "Resources"
description: "A service definition describes reusable application configuration. A deployment declaration maps instance names to those definitions. Each instance name identifies a service in the selected remote project; the definition's name is local to the application description."
---

{/* Generated from uniac-ai/agent-skills: skills/uniac/references/resources/overview.md */}
...
types are `service` and `stateful` for [service definitions](/resources/service/overview),
and `deployment` for deployment declarations. [Volumes](/resources/volume) are
...
[deployment versions](/resources/service/overview#runtime-and-deployment-versions).
...
| `services.<instance>.public_ports` | Optional [public endpoint declarations](/resources/service/networking#public-endpoints). |
